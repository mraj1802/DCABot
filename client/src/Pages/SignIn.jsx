        ...
        <>
            <section className=" 3xl:py-16 2xl:py-10 xl:py-12 lg:py-14 md:py-12 dsm:py-10 sm:py-8">
                <div className="flex flex-col items-center md:px-8 dsm:px-8 px-4 py-2 mx-auto lg:py-0">
                    <div className="w-[30%] bg-white rounded-lg shadow-xl  md:mt-0  xl:p-0 text-black">
                        <div className="px-14 py-10">
                            ...
                            >
                                ...
                                <button
                                    type="submit"
                                    className=" w-full bg-gray-600 text-white hover:bg-primary-700 focus:ring-4 focus:outline-none font-medium rounded-lg border border-gray-600 hover:bg-transparent hover:text-gray-600 px-5 py-2.5 text-center "
                                >
                                    Login
                                </button>
                            </form>
